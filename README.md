...
**FastMail** là một bài tập môn TMDT. Ứng dụng cho phép người dùng gửi tin nhắn (email) cho người dùng khác.
...
* [x] Nhấn vào nút "xem danh sách bạn" sẽ chuyển người dùng đến trang liệt kê danh sách người dùng cùng với các chức năng thêm bạn. (**MSSV**)
...
* [x] Người dùng có thể gửi hình ảnh đính kèm theo thông điệp. (**MSSV**)
...
* [x] Người dùng có thể xóa người dùng khác ra khỏi danh sách bạn. (**MSSV**)
...
* [x] Người dùng sẽ nhận được email thông báo khi họ nhận được tin nhắn cùng với link để xem tin nhắn. (**MSSV**)
